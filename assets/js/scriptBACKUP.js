$(function () {
    ...
    * On the final screen, show the number of correct answers, incorrect answers, and an option to restart the game (without reloading the page).
    ...
    //function runQuiz () {
        ...
        /* function checkAnswer is a helper function that scans the answers, see if selected is the
           answer with class .correct. If so, return true. If selected answer is class .wrong, return false.
           if no answer has been selected, return -1 */
    ...
    // Have Start Quiz! button begin quiz
    $(`#quizButton`).on(`click`, function () {
